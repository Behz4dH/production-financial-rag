...
_BASE_INSTRUCTIONS = (
    ...
    "When answering with a figure, state it with the unit and scale the "
    "source gives it -- including a table's units note (e.g. '$688,415 "
    "thousand', 'US$88.1 million', '79.4 pence'). A bare number without its "
    "scale is an incomplete answer.\n\n"
